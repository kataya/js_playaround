...
気になる JavaScript のコードを触ってみた AMD modules での コード集。ES modules でのコードは、Vite（ヴィート）を使ったものを、[vite js app](https://github.com/kataya/vite-jsapp), [vite-popup-jsapp](https://github.com/kataya/vite-popup-jsapp) で公開しています。

[src] - コードの格納先
  
## meshcode-popup.html

* [経度緯度から1次～4次のメッシュコードの計算を行い、結果を確認できるサンプルアプリ](https://kataya.github.io/js_playaround/src/meshcode-popup.html) : [ソース](https://github.com/kataya/js_playaround/blob/master/src/meshcode-popup.html)
  ...
  ![meshcode-popup](https://github.com/kataya/js_playaround/blob/master/images/app_meshcode-popup.gif?raw=true)

## custom-gl-tiles-tileinfo.html

* [XYZ タイル のLODs(z), Tile Columuns(x), Tile Rows(y) の座標をマップで対話的に確認できるサンプルアプリ](https://kataya.github.io/js_playaround/src/custom-gl-tiles-tileinfo.html) : [ソース](https://github.com/kataya/js_playaround/blob/master/src/custom-gl-tiles-tileinfo.html)
...
* [ArcGIS API for JavaScript 3.x 系でFeuatuerLayer の描画パフォーマンス表示](https://kataya.github.io/js_playaround/src/js331_drawinfo_v2.html) : [ソース](https://github.com/kataya/js_playaround/blob/master/src/js331_drawinfo_v2.html)

  ArcGIS API for JavaScript 3.31 で、FeuatuerLayer の描画パフォーマンスを表示するサンプルアプリ。


* [ArcGIS API for JavaScript 4.x 系でFeuatuerLayer の描画パフォーマンス表示 - API 4.14](https://kataya.github.io/js_playaround/src/js414_drawinfo_v2.html) : [ソース](https://github.com/kataya/js_playaround/blob/master/src/js414_drawinfo_v2.html)
...
* [ArcGIS API for JavaScript 4.x 系でFeuatuerLayer の描画パフォーマンス表示 - API 4.22](https://kataya.github.io/js_playaround/src/js422_drawinfo_v2.html) : [ソース](https://github.com/kataya/js_playaround/blob/master/src/js422_drawinfo_v2.html)
...
* [日本語表記のベクタータイルのベースマップとギャラリーを利用するサンプルアプリ](https://kataya.github.io/js_playaround/src/UsePortalBasemaps.html) : [ソース](https://github.com/kataya/js_playaround/blob/master/src/UsePortalBasemaps.html)

* [英語表記のベクタータイルのベースマップとギャラリーを利用するサンプルアプリ](https://kataya.github.io/js_playaround/src/UsePortalBasemaps_en.html) : [ソース](https://github.com/kataya/js_playaround/blob/master/src/UsePortalBasemaps_en.html)
...
* [地理院タイル等もベースマップギャラリーから利用するサンプルアプリ](https://kataya.github.io/js_playaround/src/CutsomBasemapGallery.html) : [ソース](https://github.com/kataya/js_playaround/blob/master/src/CutsomBasemapGallery.html)
...
* [World Street Map の Roads と Buildings を ベースマップを切り替えながら、スワイプや透過を変更して利用するサンプルアプリ](https://kataya.github.io/js_playaround/src/SwipeWSMapSatellite.html) : [ソース](https://github.com/kataya/js_playaround/blob/master/src/SwipeWSMapSatellite.html)
...
* [地理院地図Vector風の標準地図 を ベースマップを切り替えながら、スワイプや透過を変更して利用するサンプルアプリ](https://kataya.github.io/js_playaround/src/SwipeGSIStdVectorMap.html) : [ソース](https://github.com/kataya/js_playaround/blob/master/src/SwipeGSIStdVectorMap.html)
...
## layers-feature-Collection.html
  ...
  * [client-side graphics から FeatureLayer を作成・更新するサンプルアプリ](https://kataya.github.io/js_playaround/src/layers-feature-Collection.html) : [ソース](https://github.com/kataya/js_playaround/blob/master/src/layers-feature-Collection.html)
...
## table-text-draw-speak.html
  ...
  * [テーブルでクリックしたセルの値を、グラフィックとして文字の描画 と Web Speech API で喋らせるアプリ](https://kataya.github.io/js_playaround/src/table-text-draw-speak.html) : [ソース](https://github.com/kataya/js_playaround/blob/master/src/table-text-draw-speak.html)
...
* [BLTOXY](https://kataya.github.io/js_playaround/src/BLTOXY.html) : [ソース](https://github.com/kataya/js_playaround/blob/master/src/BLTOXY.html)
  
  国土地理院時報 2011 No.121 の「Gauss-Krüger 投影における経緯度座標及び平面直角座標相互間の座標換算についてのより簡明な計算方法」の４．１ 経緯度⇒直角座標換算プログラム例 をもとに作成
  
  
* [XYTOBL](https://kataya.github.io/js_playaround/src/XYTOBL.html) : [ソース](https://github.com/kataya/js_playaround/blob/master/src/XYTOBL.html)
